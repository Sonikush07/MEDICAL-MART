    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="row align-items-start">
                ...
                <div class="col">
                    ...
                    <form class="d-flex" method="GET" action="customers.php">
                        <input class="form-control me-2 col" type="search" name="search_user_email"
                            placeholder="Search for user (email)" aria-label="Search">
                        <button class="btn btn-outline-secondary" type="submit" name="search_user"
        ...
        <form action="customers.php" method="POST">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="<?php echo $data[0]['user_fname'] ?>" name="fname">
                <div class="form-text"></div>
            </div>
            <br>
            <div class="form-group">
                <label for="validationTooltip01">Last name</label>
                <input id="validationTooltip01" type="text" class="form-control"
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn pull-left btn-outline-warning"><a
                                    ...
                                    href="customers.php?edit=<?php echo $data[$i]['user_id'] ?>">Edit</a></button>
                        </td>
                        <td>
                            <button type="button" class="btn pull-left btn-outline-danger"><a
                                    style="text-decoration: none; color:black;"
                                    href="customers.php?delete=<?php echo $data[$i]['user_id'] ?>">Delete</a></button>
                        </td>
                    </tr>
                    <?php  }
                    ?>
